 ...
 * Size: 80 px
 * Bpp: 4
 * Opts: --font /var/folders/bq/kb5g0c6s7hq0gck8hf7gq_yw0000gn/T/font_gallery_ttf_cache.4GvVnvRhJu/docs_mockups_assets_fonts_archivo-variable_woff2.ttf --size 80 --bpp 4 --format lvgl --symbols 0123456789° --no-compress --lv-font-name font_archivo_80 -o src/font_gallery_fonts/font_archivo_80.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1083, .adv_w = 737, .box_w = 37, .box_h = 55, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 2101, .adv_w = 737, .box_w = 39, .box_h = 56, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 3193, .adv_w = 737, .box_w = 40, .box_h = 57, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 4333, .adv_w = 739, .box_w = 42, .box_h = 56, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 5509, .adv_w = 736, .box_w = 40, .box_h = 56, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 6629, .adv_w = 737, .box_w = 39, .box_h = 57, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 7741, .adv_w = 737, .box_w = 40, .box_h = 55, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 8841, .adv_w = 737, .box_w = 40, .box_h = 57, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 9981, .adv_w = 736, .box_w = 39, .box_h = 57, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 11093, .adv_w = 512, .box_w = 24, .box_h = 24, .ofs_x = 4, .ofs_y = 32}
};
