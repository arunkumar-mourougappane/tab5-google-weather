// AUTO-GENERATED by tools/gen_test_fonts.sh from tools/font_test_manifest.txt.
...
static constexpr FontTestEntry kFontTestEntries[] = {
...
static constexpr size_t kFontTestEntryCount = sizeof(kFontTestEntries) / sizeof(kFontTestEntries[0]);
